...
```{r display_table_males}
baby_data_males
```

The following code generates a scatterplot showing the number of children with a name against the rank in popularity of that name.
